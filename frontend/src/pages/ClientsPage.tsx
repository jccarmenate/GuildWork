  ...
  return (
    <div>
      ...
      <form
        ...
        className="mb-6 flex flex-col gap-2 rounded-xl border border-slate-200 bg-white p-5 shadow-sm sm:flex-row sm:flex-wrap"
      >
        <input
                    ...
                    <td className="px-4 py-2">
                      {editingId === c.id ? (
                        ...
                        <button
                          ...
                          className="font-medium text-indigo-600 transition-colors duration-150 hover:text-indigo-700 hover:underline"
                        >
                          {c.name}
                        </button>
                      )}
